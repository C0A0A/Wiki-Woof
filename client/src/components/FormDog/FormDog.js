...
function handleInputFile (e) {
  ...
  return (
    ...
    <form id="addBreed-form" onSubmit={submiting} encType="multipart/form-data">
      <h2>Añade una nueva raza</h2>
      <div class="inputElement">
      <label class="labelElement">Nombre de la raza:</label>
      <input className= {errors.name ? "danger" : "success"}
       type="text" name="name" onChange={(e) => handleInputChange(e)} value={input.name} />
      {errors.name && (
      ...
      <input className={errors.weight ? "danger" : "success"}
       type="text" name="weight" value={input.weight} onChange={(e) => handleInputChange(e)}/>
      {errors.weight && (
      ...
      <input className={errors.height ? "danger" : "success"}
       type="text" name="height" value={input.height} onChange={(e) => handleInputChange(e)}/>
      {errors.height && (
      ...
      <input className="success"
       type="text" name="life_span" value={input.life_span} onChange={(e) => handleInputChange(e)}/>
      </div>
      <div class="inputElement">
      <label class="labelElement">Temperamento/s:</label>
      <input className={errors.temperament ? "danger" : "success"}
       type="text" name="temperament" value={input.temperament} onChange={(e) => handleInputChange(e)}/>
      {errors.temperament && (
      ...
      {errors.file && (
      <p className="danger">{errors.file}</p>
      )}
      </div>
    ...
    { props.dogDetail.name && state ? (
      ...
      <NavLink exact to={`/dogs/${props.dogDetail.id}`} id="link-dog-created" >{props.dogDetail.name}</ NavLink>
      </div>
    ) : (
      <div></div>
    )
